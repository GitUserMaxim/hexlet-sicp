<p>Следующая процедура берет в качестве аргумента список пар вида символ-частота (где ни один символ не встречается более, чем в одной паре) и порождает дерево кодирования по Хаффману в соответствии с алгоритмом Хаффмана.</p>
<pre><code>(define (generate-huffman-tree pairs)
  (successive-merge (make-leaf-set pairs)))
</code></pre>
<p>Приведенная выше процедура 

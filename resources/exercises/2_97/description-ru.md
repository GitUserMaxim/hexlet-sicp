<p>а. Реализуйте этот алгоритм как процедуру 
...
<p>б. Определите процедуру, аналогичную 
<code>reduce-terms</code>
